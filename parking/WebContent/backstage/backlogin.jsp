...
<div class="tyg-div-denglv">
	<div class="tyg-div-form">
		<form action="<%=request.getContextPath()%>/admin/login.action" method="post" id="myForm">
			...
			<div style="margin:5px 0px;">
				<input type="password" placeholder="请输入密码..." id="password" name="password" style="width:270px; height:30px;"/>
			</div>
			<div style="margin:5px 0px;">
...
<script>
var path="<%=request.getContextPath()%>/validateCode/validateCode.action";
function changeCode() {
